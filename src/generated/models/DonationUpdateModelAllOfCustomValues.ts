...
/**
 * @type DonationUpdateModelAllOfCustomValues
 * 
 * @export
 */
export type DonationUpdateModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function DonationUpdateModelAllOfCustomValuesFromJSON(json: any): DonationUpdateModelAllOfCustomValues {
    return DonationUpdateModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function DonationUpdateModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): DonationUpdateModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function DonationUpdateModelAllOfCustomValuesToJSON(json: any): any {
    return DonationUpdateModelAllOfCustomValuesToJSONTyped(json, false);
}

export function DonationUpdateModelAllOfCustomValuesToJSONTyped(value?: DonationUpdateModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
