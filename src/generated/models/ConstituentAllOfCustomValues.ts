...
/**
 * @type ConstituentAllOfCustomValues
 * 
 * @export
 */
export type ConstituentAllOfCustomValues = ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf | ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf1;

export function ConstituentAllOfCustomValuesFromJSON(json: any): ConstituentAllOfCustomValues {
    return ConstituentAllOfCustomValuesFromJSONTyped(json, false);
}

export function ConstituentAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConstituentAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function ConstituentAllOfCustomValuesToJSON(json: any): any {
    return ConstituentAllOfCustomValuesToJSONTyped(json, false);
}

export function ConstituentAllOfCustomValuesToJSONTyped(value?: ConstituentAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
