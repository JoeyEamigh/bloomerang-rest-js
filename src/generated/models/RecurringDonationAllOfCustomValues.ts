...
/**
 * @type RecurringDonationAllOfCustomValues
 * 
 * @export
 */
export type RecurringDonationAllOfCustomValues = ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf | ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf1;

export function RecurringDonationAllOfCustomValuesFromJSON(json: any): RecurringDonationAllOfCustomValues {
    return RecurringDonationAllOfCustomValuesFromJSONTyped(json, false);
}

export function RecurringDonationAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecurringDonationAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function RecurringDonationAllOfCustomValuesToJSON(json: any): any {
    return RecurringDonationAllOfCustomValuesToJSONTyped(json, false);
}

export function RecurringDonationAllOfCustomValuesToJSONTyped(value?: RecurringDonationAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
