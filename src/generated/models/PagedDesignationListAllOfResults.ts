...
/**
 * @type PagedDesignationListAllOfResults
 * 
 * @export
 */
export type PagedDesignationListAllOfResults = PledgeIdPaymentsGet200Response | TransactionsGet200ResponseAllOfResultsInnerAllOfDesignationsInnerOneOf | TransactionsGet200ResponseAllOfResultsInnerAllOfDesignationsInnerOneOf1 | TransactionsGet200ResponseAllOfResultsInnerAllOfDesignationsInnerOneOf2 | TransactionsGet200ResponseAllOfResultsInnerAllOfDesignationsInnerOneOf3;

export function PagedDesignationListAllOfResultsFromJSON(json: any): PagedDesignationListAllOfResults {
    return PagedDesignationListAllOfResultsFromJSONTyped(json, false);
}

export function PagedDesignationListAllOfResultsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PagedDesignationListAllOfResults {
    if (json == null) {
        return json;
    }
...
export function PagedDesignationListAllOfResultsToJSON(json: any): any {
    return PagedDesignationListAllOfResultsToJSONTyped(json, false);
}

export function PagedDesignationListAllOfResultsToJSONTyped(value?: PagedDesignationListAllOfResults | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
