...
/**
 * @type RecurringDonationUpdateModelAllOfAttachments
 * 
 * @export
 */
export type RecurringDonationUpdateModelAllOfAttachments = InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf | InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf1;

export function RecurringDonationUpdateModelAllOfAttachmentsFromJSON(json: any): RecurringDonationUpdateModelAllOfAttachments {
    return RecurringDonationUpdateModelAllOfAttachmentsFromJSONTyped(json, false);
}

export function RecurringDonationUpdateModelAllOfAttachmentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecurringDonationUpdateModelAllOfAttachments {
    if (json == null) {
        return json;
    }
...
export function RecurringDonationUpdateModelAllOfAttachmentsToJSON(json: any): any {
    return RecurringDonationUpdateModelAllOfAttachmentsToJSONTyped(json, false);
}

export function RecurringDonationUpdateModelAllOfAttachmentsToJSONTyped(value?: RecurringDonationUpdateModelAllOfAttachments | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
