...
/**
 * @type DonationCreateModelAllOfCustomValues
 * 
 * @export
 */
export type DonationCreateModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function DonationCreateModelAllOfCustomValuesFromJSON(json: any): DonationCreateModelAllOfCustomValues {
    return DonationCreateModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function DonationCreateModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): DonationCreateModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function DonationCreateModelAllOfCustomValuesToJSON(json: any): any {
    return DonationCreateModelAllOfCustomValuesToJSONTyped(json, false);
}

export function DonationCreateModelAllOfCustomValuesToJSONTyped(value?: DonationCreateModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
