...
/**
 * @type InteractionInputModelAllOfCustomValues
 * 
 * @export
 */
export type InteractionInputModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function InteractionInputModelAllOfCustomValuesFromJSON(json: any): InteractionInputModelAllOfCustomValues {
    return InteractionInputModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function InteractionInputModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): InteractionInputModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function InteractionInputModelAllOfCustomValuesToJSON(json: any): any {
    return InteractionInputModelAllOfCustomValuesToJSONTyped(json, false);
}

export function InteractionInputModelAllOfCustomValuesToJSONTyped(value?: InteractionInputModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
