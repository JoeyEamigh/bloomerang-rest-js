...
/**
 * @type PledgeUpdateModelAllOfCustomValues
 * 
 * @export
 */
export type PledgeUpdateModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function PledgeUpdateModelAllOfCustomValuesFromJSON(json: any): PledgeUpdateModelAllOfCustomValues {
    return PledgeUpdateModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function PledgeUpdateModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PledgeUpdateModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function PledgeUpdateModelAllOfCustomValuesToJSON(json: any): any {
    return PledgeUpdateModelAllOfCustomValuesToJSONTyped(json, false);
}

export function PledgeUpdateModelAllOfCustomValuesToJSONTyped(value?: PledgeUpdateModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
