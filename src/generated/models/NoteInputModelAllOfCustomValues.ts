...
/**
 * @type NoteInputModelAllOfCustomValues
 * 
 * @export
 */
export type NoteInputModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function NoteInputModelAllOfCustomValuesFromJSON(json: any): NoteInputModelAllOfCustomValues {
    return NoteInputModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function NoteInputModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): NoteInputModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function NoteInputModelAllOfCustomValuesToJSON(json: any): any {
    return NoteInputModelAllOfCustomValuesToJSONTyped(json, false);
}

export function NoteInputModelAllOfCustomValuesToJSONTyped(value?: NoteInputModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
