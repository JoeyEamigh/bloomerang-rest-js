...
/**
 * @type PledgeAllOfCustomValues
 * 
 * @export
 */
export type PledgeAllOfCustomValues = ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf | ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf1;

export function PledgeAllOfCustomValuesFromJSON(json: any): PledgeAllOfCustomValues {
    return PledgeAllOfCustomValuesFromJSONTyped(json, false);
}

export function PledgeAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PledgeAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function PledgeAllOfCustomValuesToJSON(json: any): any {
    return PledgeAllOfCustomValuesToJSONTyped(json, false);
}

export function PledgeAllOfCustomValuesToJSONTyped(value?: PledgeAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
