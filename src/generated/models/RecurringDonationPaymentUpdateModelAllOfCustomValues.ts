...
/**
 * @type RecurringDonationPaymentUpdateModelAllOfCustomValues
 * 
 * @export
 */
export type RecurringDonationPaymentUpdateModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function RecurringDonationPaymentUpdateModelAllOfCustomValuesFromJSON(json: any): RecurringDonationPaymentUpdateModelAllOfCustomValues {
    return RecurringDonationPaymentUpdateModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function RecurringDonationPaymentUpdateModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): RecurringDonationPaymentUpdateModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function RecurringDonationPaymentUpdateModelAllOfCustomValuesToJSON(json: any): any {
    return RecurringDonationPaymentUpdateModelAllOfCustomValuesToJSONTyped(json, false);
}

export function RecurringDonationPaymentUpdateModelAllOfCustomValuesToJSONTyped(value?: RecurringDonationPaymentUpdateModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
