...
/**
 * @type PledgeCreateModelAllOfAttachments
 * 
 * @export
 */
export type PledgeCreateModelAllOfAttachments = InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf | InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf1;

export function PledgeCreateModelAllOfAttachmentsFromJSON(json: any): PledgeCreateModelAllOfAttachments {
    return PledgeCreateModelAllOfAttachmentsFromJSONTyped(json, false);
}

export function PledgeCreateModelAllOfAttachmentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PledgeCreateModelAllOfAttachments {
    if (json == null) {
        return json;
    }
...
export function PledgeCreateModelAllOfAttachmentsToJSON(json: any): any {
    return PledgeCreateModelAllOfAttachmentsToJSONTyped(json, false);
}

export function PledgeCreateModelAllOfAttachmentsToJSONTyped(value?: PledgeCreateModelAllOfAttachments | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
