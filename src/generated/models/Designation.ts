...
export interface Designation {
     ...
     * @memberof Designation
     */
    acknowledgementStatus?: DesignationAcknowledgementStatusEnum;
    /**
     * 
     * @type {Array<number>}
     * @memberof Designation
     ...
     * @memberof Designation
     */
    tributeType?: DesignationTributeTypeEnum;
    /**
     * 
     * @type {Array<number>}
     * @memberof Designation
...
* @enum {string}
*/
export enum DesignationAcknowledgementStatusEnum {
    Yes = 'Yes',
    No = 'No',
...
* @enum {string}
*/
export enum DesignationTributeTypeEnum {
    InHonorOf = 'InHonorOf',
...
/**
 * Check if a given object implements the Designation interface.
 */
export function instanceOfDesignation(value: object): value is Designation {
    return true;
}

export function DesignationFromJSON(json: any): Designation {
    return DesignationFromJSONTyped(json, false);
}

export function DesignationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Designation {
    if (json == null) {
        return json;
    }
    return {
...
export function DesignationToJSON(json: any): Designation {
    return DesignationToJSONTyped(json, false);
}

export function DesignationToJSONTyped(value?: Designation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const DesignationPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
