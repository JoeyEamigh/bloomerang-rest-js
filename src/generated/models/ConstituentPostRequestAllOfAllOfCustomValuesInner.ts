...
/**
 * @type ConstituentPostRequestAllOfAllOfCustomValuesInner
 * 
 * @export
 */
export type ConstituentPostRequestAllOfAllOfCustomValuesInner = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function ConstituentPostRequestAllOfAllOfCustomValuesInnerFromJSON(json: any): ConstituentPostRequestAllOfAllOfCustomValuesInner {
    return ConstituentPostRequestAllOfAllOfCustomValuesInnerFromJSONTyped(json, false);
}

export function ConstituentPostRequestAllOfAllOfCustomValuesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConstituentPostRequestAllOfAllOfCustomValuesInner {
    if (json == null) {
        return json;
    }
...
export function ConstituentPostRequestAllOfAllOfCustomValuesInnerToJSON(json: any): any {
    return ConstituentPostRequestAllOfAllOfCustomValuesInnerToJSONTyped(json, false);
}

export function ConstituentPostRequestAllOfAllOfCustomValuesInnerToJSONTyped(value?: ConstituentPostRequestAllOfAllOfCustomValuesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
