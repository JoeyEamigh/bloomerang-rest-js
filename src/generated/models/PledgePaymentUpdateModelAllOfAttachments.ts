...
/**
 * @type PledgePaymentUpdateModelAllOfAttachments
 * 
 * @export
 */
export type PledgePaymentUpdateModelAllOfAttachments = InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf | InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf1;

export function PledgePaymentUpdateModelAllOfAttachmentsFromJSON(json: any): PledgePaymentUpdateModelAllOfAttachments {
    return PledgePaymentUpdateModelAllOfAttachmentsFromJSONTyped(json, false);
}

export function PledgePaymentUpdateModelAllOfAttachmentsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PledgePaymentUpdateModelAllOfAttachments {
    if (json == null) {
        return json;
    }
...
export function PledgePaymentUpdateModelAllOfAttachmentsToJSON(json: any): any {
    return PledgePaymentUpdateModelAllOfAttachmentsToJSONTyped(json, false);
}

export function PledgePaymentUpdateModelAllOfAttachmentsToJSONTyped(value?: PledgePaymentUpdateModelAllOfAttachments | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
