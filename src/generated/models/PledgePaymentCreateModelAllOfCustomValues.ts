...
/**
 * @type PledgePaymentCreateModelAllOfCustomValues
 * 
 * @export
 */
export type PledgePaymentCreateModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function PledgePaymentCreateModelAllOfCustomValuesFromJSON(json: any): PledgePaymentCreateModelAllOfCustomValues {
    return PledgePaymentCreateModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function PledgePaymentCreateModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PledgePaymentCreateModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function PledgePaymentCreateModelAllOfCustomValuesToJSON(json: any): any {
    return PledgePaymentCreateModelAllOfCustomValuesToJSONTyped(json, false);
}

export function PledgePaymentCreateModelAllOfCustomValuesToJSONTyped(value?: PledgePaymentCreateModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
