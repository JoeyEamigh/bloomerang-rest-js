...
/**
 * @type PledgePaymentAllOfCustomValues
 * 
 * @export
 */
export type PledgePaymentAllOfCustomValues = ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf | ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf1;

export function PledgePaymentAllOfCustomValuesFromJSON(json: any): PledgePaymentAllOfCustomValues {
    return PledgePaymentAllOfCustomValuesFromJSONTyped(json, false);
}

export function PledgePaymentAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PledgePaymentAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function PledgePaymentAllOfCustomValuesToJSON(json: any): any {
    return PledgePaymentAllOfCustomValuesToJSONTyped(json, false);
}

export function PledgePaymentAllOfCustomValuesToJSONTyped(value?: PledgePaymentAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
