 ...
 * @export
 * @interface HouseholdInputModelAllOfMembers
 */
export interface HouseholdInputModelAllOfMembers {
    /**
     * 
     * @type {string}
     * @memberof HouseholdInputModelAllOfMembers
     */
    type?: HouseholdInputModelAllOfMembersTypeEnum;
    /**
     * 
     * @type {string}
     * @memberof HouseholdInputModelAllOfMembers
     */
    status?: HouseholdInputModelAllOfMembersStatusEnum;
    /**
     * 
     * @type {string}
     * @memberof HouseholdInputModelAllOfMembers
     ...
     * @memberof HouseholdInputModelAllOfMembers
     */
    gender?: HouseholdInputModelAllOfMembersGenderEnum;
    /**
     * 
     * @type {Date}
     * @memberof HouseholdInputModelAllOfMembers
     ...
     * @memberof HouseholdInputModelAllOfMembers
     */
    profilePictureType?: HouseholdInputModelAllOfMembersProfilePictureTypeEnum;
    /**
     * 
...
* @enum {string}
*/
export enum HouseholdInputModelAllOfMembersTypeEnum {
...
* @enum {string}
*/
export enum HouseholdInputModelAllOfMembersStatusEnum {
    Active = 'Active',
    Inactive = 'Inactive',
    Deceased = 'Deceased'
}
...
* @enum {string}
*/
export enum HouseholdInputModelAllOfMembersGenderEnum {
    Male = 'Male',
    Female = 'Female',
    Other = 'Other'
}
...
* @enum {string}
*/
export enum HouseholdInputModelAllOfMembersProfilePictureTypeEnum {
    None = 'None',
    Custom = 'Custom',
    Twitter = 'Twitter'
}
...
/**
 * Check if a given object implements the HouseholdInputModelAllOfMembers interface.
 */
export function instanceOfHouseholdInputModelAllOfMembers(value: object): value is HouseholdInputModelAllOfMembers {
    return true;
}

export function HouseholdInputModelAllOfMembersFromJSON(json: any): HouseholdInputModelAllOfMembers {
    return HouseholdInputModelAllOfMembersFromJSONTyped(json, false);
}

export function HouseholdInputModelAllOfMembersFromJSONTyped(json: any, ignoreDiscriminator: boolean): HouseholdInputModelAllOfMembers {
    if (json == null) {
        return json;
    }
    return {
...
export function HouseholdInputModelAllOfMembersToJSON(json: any): HouseholdInputModelAllOfMembers {
    return HouseholdInputModelAllOfMembersToJSONTyped(json, false);
}

export function HouseholdInputModelAllOfMembersToJSONTyped(value?: HouseholdInputModelAllOfMembers | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
...
export const HouseholdInputModelAllOfMembersPropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
