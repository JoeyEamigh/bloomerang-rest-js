...
/**
 * @type ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInner
 * 
 * @export
 */
export type ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInner = ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf | ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerOneOf1;

export function ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerFromJSON(json: any): ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInner {
    return ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerFromJSONTyped(json, false);
}

export function ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInner {
    if (json == null) {
        return json;
    }
...
export function ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerToJSON(json: any): any {
    return ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerToJSONTyped(json, false);
}

export function ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInnerToJSONTyped(value?: ConstituentsGet200ResponseAllOfResultsInnerAllOfAllOfCustomValuesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
