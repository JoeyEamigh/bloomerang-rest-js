...
/**
 * @type InteractionPostRequestAllOfAllOfAttachmentsInner
 * 
 * @export
 */
export type InteractionPostRequestAllOfAllOfAttachmentsInner = InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf | InteractionPostRequestAllOfAllOfAttachmentsInnerOneOf1;

export function InteractionPostRequestAllOfAllOfAttachmentsInnerFromJSON(json: any): InteractionPostRequestAllOfAllOfAttachmentsInner {
    return InteractionPostRequestAllOfAllOfAttachmentsInnerFromJSONTyped(json, false);
}

export function InteractionPostRequestAllOfAllOfAttachmentsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): InteractionPostRequestAllOfAllOfAttachmentsInner {
    if (json == null) {
        return json;
    }
...
export function InteractionPostRequestAllOfAllOfAttachmentsInnerToJSON(json: any): any {
    return InteractionPostRequestAllOfAllOfAttachmentsInnerToJSONTyped(json, false);
}

export function InteractionPostRequestAllOfAllOfAttachmentsInnerToJSONTyped(value?: InteractionPostRequestAllOfAllOfAttachmentsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
