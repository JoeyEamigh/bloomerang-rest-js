...
/**
 * @type PledgePaymentUpdateModelAllOfCustomValues
 * 
 * @export
 */
export type PledgePaymentUpdateModelAllOfCustomValues = ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf1 | ConstituentPostRequestAllOfAllOfCustomValuesInnerOneOf2;

export function PledgePaymentUpdateModelAllOfCustomValuesFromJSON(json: any): PledgePaymentUpdateModelAllOfCustomValues {
    return PledgePaymentUpdateModelAllOfCustomValuesFromJSONTyped(json, false);
}

export function PledgePaymentUpdateModelAllOfCustomValuesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PledgePaymentUpdateModelAllOfCustomValues {
    if (json == null) {
        return json;
    }
...
export function PledgePaymentUpdateModelAllOfCustomValuesToJSON(json: any): any {
    return PledgePaymentUpdateModelAllOfCustomValuesToJSONTyped(json, false);
}

export function PledgePaymentUpdateModelAllOfCustomValuesToJSONTyped(value?: PledgePaymentUpdateModelAllOfCustomValues | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
